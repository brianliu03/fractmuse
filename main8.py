...
from algo import expandSnotes,expandSnotesNoSpan, interpolate, addDistribution, snotes_to_notes, snotes_to_notes_offset, snotes_to_notes_tritones
...
def main():
    ...
    notes_0 = snotes_to_notes(notes_0)
    notes_1 = snotes_to_notes(notes_1)
    ...
    notes_1 = snotes_to_notes_tritones(notes_1)
    ...
    notes_2 = snotes_to_notes(notes_2)
    ...
    direction_1=[50,20]
    notes_1 = scale(modulus_1, shift_1, spans_1, direction_1)
    notes_1 = snotes_to_notes_offset(notes_1, notes_0[len(notes_0) - 1].time + notes_0[len(notes_0) - 1].span)
    direction_1=[20,88]
    notes_1 = scale(modulus_1, shift_1, spans_1, direction_1)
    notes_1 = snotes_to_notes_offset(notes_1, notes_0[len(notes_0) - 1].time + notes_0[len(notes_0) - 1].span)
